...
- Mickey Petersen. [[https://www.masteringemacs.org/][Mastering Emacs]], ePUB

- O agregador de blogs sobre Emacs [[https://planet.emacsen.org/][Planet Emacs]]

- Os vídeos (em inglês) do canal System Crafters: https://www.youtube.com/c/SystemCrafters/

- As discussões em https://www.reddit.com/r/emacs/
